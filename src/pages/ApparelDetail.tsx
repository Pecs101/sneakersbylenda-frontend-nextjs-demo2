...
export default function ApparelDetail() {
  ...
  const product = TSHIRTS.find(p => p.id === id);
  const similarItems = TSHIRTS.filter(p => p.id !== id).slice(0, 4);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-24">
          ...
          >
            ...
            {/* Color Selection */}
            <div className="mb-8">
              <h3 className="font-bold text-slate-900 mb-4">Select Color</h3>
            ...
            <div className="mb-10">
              <div className="flex justify-between items-center mb-4">
                ...
                <button className="text-sm text-slate-400 hover:text-brand transition-colors">Size Guide</button>
              </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-8 border-t border-slate-100">
              <div className="flex flex-col items-center text-center space-y-2">
                ...
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Organic Cotton</span>
              </div>
              <div className="flex flex-col items-center text-center space-y-2">
                <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center text-brand">
                  <Truck size={20} />
                </div>
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Fast Shipping</span>
              </div>
              <div className="flex flex-col items-center text-center space-y-2">
                <div className="w-10 h-10 bg-slate-50 rounded-full flex items-center justify-center text-brand">
                  <RefreshCw size={20} />
                </div>
                <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Easy Returns</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        {/* Similar Items */}
        <div>
          <h2 className="text-3xl font-display font-extrabold text-slate-900 mb-12">SIMILAR ITEMS</h2>
